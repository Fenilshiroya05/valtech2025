...
public class OwnerVO {
	...
	private List<Long> watches; //Id's of watches
	...
	public static OwnerVO from(Owner owner) {
		...
		List<Long> watches= owner.getWatches() == null ? List.of() : 
			owner.getWatches().stream().map(o->o.getId()).collect(Collectors.toList());
